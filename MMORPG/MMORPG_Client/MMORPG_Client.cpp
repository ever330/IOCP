// MMORPG_Client.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CMMORPGClientApp, CWinApp)
...
CMMORPGClientApp::CMMORPGClientApp()
{
	// 다시 시작 관리자 지원
...
// 유일한 CMMORPGClientApp 개체입니다.

CMMORPGClientApp theApp;


// CMMORPGClientApp 초기화

BOOL CMMORPGClientApp::InitInstance()
{
	_CrtDumpMemoryLeaks();
